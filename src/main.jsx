...
function Shell({ children, eyebrow = 'TÃO JOGANDO AINDA?' }) { return <main className="app"><div className="grain" /><div className="game-texture" aria-hidden="true"><span>???</span><span>+1</span><span>≈</span><span>42</span></div><header className="topbar"><span className="brand"><i />{eyebrow}</span><span className="live-dot">● AO VIVO</span></header>{children}</main>; }
